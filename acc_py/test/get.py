...
from acc_py.utilities.get import *
...
def main() -> None:
    instructions = """
        ...
        Functions available in validadte.py:
            - _get_json(json_path: Path) -> dict[str, str]
            - _get_period(default_period: Period) -> Period
            - _get_category(dict_cat: dict[str, str])
            - _doc_printer(func: callable) -> None
"""
